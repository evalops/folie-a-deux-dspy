...
class TestMainCLI:
    ...
    def test_main_with_output_file(self, mock_file, mock_setup_logging, mock_folie_a_deux):
    ...
    @patch('folie_a_deux.main.setup_logging')
    @patch('builtins.open', new_callable=mock_open)
    def test_main_ablation_with_output(self, mock_file, mock_setup_logging, mock_ablation):
    ...
    def test_main_keyboard_interrupt(self, mock_setup_logging):
        ...
        with patch('folie_a_deux.main.ExperimentConfig.from_env', side_effect=KeyboardInterrupt):
            exit_code = main([])
            assert exit_code == 1
    ...
    def test_main_general_exception(self, mock_setup_logging):
        ...
        with patch('folie_a_deux.main.ExperimentConfig.from_env', side_effect=ValueError("Test error")):
            exit_code = main([])
            assert exit_code == 1
