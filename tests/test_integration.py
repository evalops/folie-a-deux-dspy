...
from folie_a_deux.verifier import Verifier
from folie_a_deux.metrics import truth_accuracy, agreement_metric_factory, blended_metric_factory
...
class TestFrameworkIntegration:
    ...
    def test_experiment_components_integration(self, mock_agreement_rate, mock_evaluate, mock_miprov2):
    ...
    def test_full_pipeline_mock_integration(self):
        ...
        with patch('folie_a_deux.experiment.MIPROv2') as mock_miprov2, \
            ...
            assert mock_agreement_rate.call_count == 4  # 2 rounds * 2 agreement calculations
