...
class TestFolieADeux:
    ...
    def test_folie_a_deux_basic_run(self, mock_agreement_rate, mock_evaluate, 
                                   mock_miprov2, mock_verifier, mock_validate,
                                   mock_get_train, mock_get_dev):
    ...
    @patch('folie_a_deux.experiment.get_train_unlabeled')
    @patch('folie_a_deux.experiment.validate_dataset')
    def test_folie_a_deux_config_overrides(self, mock_validate, mock_get_train, mock_get_dev):
        ...
        with patch('folie_a_deux.experiment.Verifier'), \
             patch('folie_a_deux.experiment.MIPROv2'), \
